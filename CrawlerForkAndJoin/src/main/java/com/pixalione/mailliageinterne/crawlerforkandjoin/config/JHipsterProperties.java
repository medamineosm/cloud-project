...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "CrawlerForkAndJoin@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "CrawlerForkAndJoin API";

        private String description = "CrawlerForkAndJoin API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "CrawlerForkAndJoin";
